...
/* 
    ...
    $query1 = "SELECT firstName, lastName, title, profilePicture FROM doctors WHERE doctorID = '$doctorID'";
    ...
    $doctor_picture = $data['profilePicture'];


	  $doctor_title_name = $doctor_title." ".$doctor_lastname;
...
*/
    ...
    if(isset($_POST['submit'])){
      ...
      $itemName = $db->escapeString($_POST['itemName']);
      ...
      $query = "INSERT INTO `feeditemshfkjkjdlkssdlk` (`itemName`, `description`, `accountID`) VALUES ('$itemName', '$description', '$accountID');";
                ...
                if($alertMe == 1){
                    echo('<div class="alert border-0 alert-dismissible fade show py-2">');
                      echo('<div class="d-flex align-items-center">');
                        ...
                        echo('</div>');
                        echo('<div class="ms-3">');
                          echo('<h6 class="mb-0 text-white">Feed Item Added Successfully</h6>');
                          echo('<div class="text-white">You can start using new item.</div>');
                          echo('</div>');
                        echo('</div>');
              ...
              <div class="card border-top border-0 border-4 border-white">
                <div class="card-body p-5">
                  <div class="card-title d-flex align-items-center">
                    <div>
                      <i class="bx bx-cookie me-1 font-22 text-white"></i>
                    </div>
                    <h5 class="mb-0 text-white">Add Feed Item</h5>
                  </div>
                  <hr />
                  <form class="row g-3" method="POST" action="addFeedItem.php">
